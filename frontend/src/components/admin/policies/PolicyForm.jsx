...
export const PolicyForm = ({ initialData = {}, onSubmit, onCancel, mode = 'create' }) => {
  ...
  const handleBackdropClick = (e) => {
    if (e.target === formRef.current && !loading) {
      handleCancel();
    }
  };
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="policy-form-backdrop fixed inset-0 bg-gray-900/70 dark:bg-gray-900/80 backdrop-blur-sm z-50 overflow-y-auto flex items-center justify-center p-4"
      ...
      >
        <motion.div 
          ...
          transition={{ duration: 0.2 }}
          className="w-full max-w-6xl bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden max-h-[90vh] relative z-10"
