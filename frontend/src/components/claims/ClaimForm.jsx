...
export const ClaimForm = ({ initialData = {}, onSubmit, onCancel, policies = [], mode = 'create' }) => {
  ...
  const handleCancel = () => {
    ...
    console.log('onCancel callback exists:', !!onCancel); // Debug
    console.log('navigate function exists:', !!navigate); // Debug
    
    // If onCancel callback is provided, use it
    if (onCancel) {
      console.log('Calling onCancel callback');
      onCancel();
      return; // Exit after calling onCancel
    }
    
    // Otherwise navigate back to claims dashboard
    console.log('Navigating to /dashboard/claims');
    navigate('/dashboard/claims');
  };
  ...
  return (
    <motion.div
      ...
      ref={backdropRef}
      className="fixed inset-0 bg-gray-900/70 dark:bg-gray-900/80 backdrop-blur-sm z-50 overflow-y-auto flex items-center justify-center p-4"
    ...
    >
      <motion.div
        ...
        transition={{ duration: 0.2 }}
        className="w-full max-w-7xl bg-gray-50 dark:bg-gray-900 rounded-xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col relative z-10"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header - Fixed at top */}
        <div className="flex-shrink-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm relative z-10">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 relative z-20">
                <button
                  ...
                  disabled={loading}
                  className="px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors cursor-pointer"
                >
