...
const Footer = () => {
  const footerLinks = {
    Products: [
      ...
      { name: 'Property Insurance', href: '/products/property' },
  ...
  const features = [
    ...
    },
    {
      icon: BanknotesIcon,
      title: 'Best Rates',
      description: 'Competitive premiums guaranteed',
    },
    {
      icon: ChartBarIcon,
    ...
    },
    {
      ...
      title: 'Mobile App',
      description: 'Manage your policies on the go',
    },
  ];
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {features.map((feature, index) => (
            ...
            >
              <div className="inline-flex items-center justify-center w-12 h-12 mb-4 rounded-lg bg-blue-100 dark:bg-blue-900/30 group-hover:bg-blue-200 dark:group-hover:bg-blue-900/50 transition-colors duration-300">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4 text-sm">
              Get the latest insurance insights and tips.
            </p>
