...
const claimSchema = new mongoose.Schema({
  claimNumber: {
    type: String,
    required: false,  // Changed to false - will be generated by service
    unique: true
  },
  policy: {
...
// FIXED: SIMPLIFIED pre-save hook - ONLY handle statusHistory
// REMOVED the claim number generation since it's done in the service
